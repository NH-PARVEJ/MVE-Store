...
<html lang="en">
   ...
   <body>
                              ...
                              <div class="row g-3">
                                 <div class="col-12 ">
                                    ...
                                    <div class="ms-auto position-relative">
                                       ...
                                       <input type="text" class="form-control radius-30 ps-5" id="inputName" placeholder="Enter Name"  name="name" :value="old('name')" required="required">
                                    </div>
                                 </div>
                                 <!-- Email Address -->
                                 <div class="col-12">
                                    ...
                                    <div class="ms-auto position-relative">
                                       ...
                                       <input type="email" class="form-control radius-30 ps-5" id="inputEmailAddress" placeholder="Email Address" name="email" :value="old('email')" required="required">
                                    </div>
                                 </div>
                                 <!-- Password -->
                                 <div class="col-12">
                                 ...
                                 <div class="col-12">
                                    ...
                                    <div class="ms-auto position-relative">
                                       <div class="position-absolute top-50 translate-middle-y search-icon px-3"><i class="bi bi-lock-fill"></i></div>
                                       <input type="password" class="form-control radius-30 ps-5" id="inputChoosePassword" placeholder="Enter Password"  name="password_confirmation"  required="required">
                                    </div>
                                 </div>
                                 <div class="col-12">
                                    <div class="form-check form-switch">
                                       <input class="form-check-input" type="checkbox" id="flexSwitchCheckChecked" required="required">
      ...
      <script src="{{asset('backend/assets/js/pace.min.jsbackend/')}}"></script>
   </body>