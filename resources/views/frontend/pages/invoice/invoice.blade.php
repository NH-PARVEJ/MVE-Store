...
<body>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6  text-end">
                                        <div class="invoice-numb">
                                            <h4 class="invoice-header-1 mb-10 mt-20">Invoice No: <span class="text-heading">#1970191</span></h4>
                                    ...
                                    <div class="col-lg-4 col-md-6">
                                        <div class="invoice-number">
                                            ...
                                            <p class="invoice-addr-1">
                                                ...
                                                <abbr title="Email">Email: </abbr><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="ceada1a0baafadba8ea0abbdbaa3afbcbae0ada1a3">[email&#160;protected]</a><br>
                                            </p>
                                        </div>
                                    </div>
                                    <div class="col-lg-4 col-md-6">
                                        <div class="invoice-number">
                                            ...
                                            <p class="invoice-addr-1">
                                                ...
                                                <abbr title="Email">Email: </abbr><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="88e6eee7c8ffedeaf2a6ebe7e5a6f8e4">[email&#160;protected]</a><br>
                                            </p>
                                        </div>
                                    </div>
                                    <div class="col-lg-4 col-md-6">
                                        <div class="invoice-number">
                                            ...
                                            <p class="invoice-addr-1">
                                                ...
                                                <strong>Payment Method:</strong> Payoneer<br />
                                                <strong>Status:</strong> <span class="text-brand">Completed</span>
                                            </p>
                                        </div>
                                    </div>
                                </div>
    ...
    <!-- Vendor JS-->
    <script data-cfasync="false" src="/cdn-cgi/scripts/5c5dd728/cloudflare-static/email-decode.min.js"></script><script src="{{asset('frontend/assets/js/vendor/modernizr-3.6.0.min.js')}}"></script>
